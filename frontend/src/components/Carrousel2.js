...
const Carrousel2 = ({ todasLasCategorias }) => {
 var settings = {
    dots: false,
    infinite: true,
    speed: 500,
  ...
  return (
    <div className='containerImg2' style={{ width: '90%', margin: 'auto' }}>
      <Slider {...settings}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Carrousel2)